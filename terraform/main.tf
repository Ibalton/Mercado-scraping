...
module "lambda" {
  ...
  cognito_client_id         = module.cognito.spa.id
  cognito_client_secret     = module.cognito.spa.client_secret
  cognito_domain            = module.cognito.cognito_domain
  frontend_url              = module.ecs.backend_url # Use backend URL for callback
}
...
module "ecs" {
  ...
  cognito_pool_id   = module.cognito.cognito_user_pool_id
  cognito_client_id = module.cognito.spa.id

  depends_on = [module.ecr_build, module.cognito ]
}
